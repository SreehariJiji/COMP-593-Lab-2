...
# Created Function that prints student name and ID	
...
# Created Function that adds pizza toppings to data structure
...
# Created Function that prints bullet list of pizza toppings
...
# Created Function that prints comma-separated list of movie genres
...
# Created Function that prints comma-separated list of movie titles
